...
class Video {
  late int id;
  late List<VideoResults> videoresults;

  Video({required this.id, required this.videoresults});
  ...
  Video.fromJson(Map<String, dynamic> json) {
    ...
    if (json['results'] != null) {
      ...
      json['results'].forEach((v) {
        videoresults.add(VideoResults.fromJson(v));
      });
    }
  }
  ...
  Map<String, dynamic> toJson() {
    ...
    data['id'] = id;
    data['results'] = videoresults.map((v) => v.toJson()).toList();
    return data;
  }
}
